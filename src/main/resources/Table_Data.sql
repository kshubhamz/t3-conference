INSERT INTO ticket_types (ticket_type_code,ticket_type_name,TICKET_TYPE_DESC,includes_workshop)
...
INSERT INTO sessions (session_id,session_name,session_length,SESSION_DESC)
